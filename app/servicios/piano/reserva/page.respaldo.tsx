      ...
      <div className="mx-auto max-w-3xl px-6 md:px-10 py-16 md:py-24">
        {reservaCreada ? (
          <div className="text-center animate-fade-in-up">
            ...
            <p className="text-base md:text-lg text-neutral-600 leading-relaxed max-w-xl mx-auto mb-10">
              Aún falta un paso: confirmar el pago. Esa parte del proceso se
              conecta en la siguiente etapa — por ahora tu reserva quedó
              guardada como <strong>pendiente de pago</strong>. Te
              contactaremos para coordinar el pago y confirmar tu clase.
            </p>
