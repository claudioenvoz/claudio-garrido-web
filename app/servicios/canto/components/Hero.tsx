      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="flex flex-col md:flex-row md:items-center gap-10 md:gap-12 py-16 md:py-24">
          ...
          >
            ...
            >
              Conviértete en el cantante que siempre imaginaste ser.
            </h1>
            ...
            >
              Desarrolla una voz sólida, libre y expresiva mediante un
              proceso completamente personalizado que se adapta a tu nivel y
              te acompaña hasta convertirte en el cantante que deseas ser.
            </p>
